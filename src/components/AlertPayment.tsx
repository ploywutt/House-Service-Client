...
export function AlertPayment() {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle><div id="Check-Symbol" className="p-8">
        ...
        <AlertDialogFooter>
          <AlertDialogCancel> <Button variant="secondary" className="w-[180px]">
              ยกเลิก
            </Button></AlertDialogCancel>
          <AlertDialogAction><Button variant="default" className="w-[180px]">
              ตกลง
